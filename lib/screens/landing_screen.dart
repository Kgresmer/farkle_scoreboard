                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Container(
                          ...
                          child: TextButton(
                              onPressed: () => navToExistingPlayers(context), child: Text('Player Stats'))),
                      Container(
                          height: constraints.maxHeight * .09,
                          width: constraints.maxWidth / 2 - 20,
                          child: TextButton(
                              onPressed: () => showRulesModal(context, constraints.maxHeight * .8, constraints.maxWidth *.8), child: Text('Rules')))
                    ],
                  )
                ],
              ),
